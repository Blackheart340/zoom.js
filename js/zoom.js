+function ($) { "use strict";
  ...
  function ZoomService () {
    ...
    $(document.body).on('click', '[data-action="zoom"]', $.proxy(this._zoom, this))
  }
  ...
  ZoomService.prototype._zoom = function (e) {
    ...
    $(window).on('scroll.zoom', $.proxy(this._scrollHandler, this)) // todo(fat) throttle?
    $(document).on('click.zoom', $.proxy(this._clickHandler, this))
    $(document).on('keyup.zoom', $.proxy(this._keyHandler, this))
    $(document).on('touchstart.zoom', $.proxy(this._touchStart, this))
  ...
  Zoom.prototype.dispose = function () {
    if (this._targetImageWrap && this._targetImageWrap.parentNode) {
      ...
      $(document.body).removeClass('zoom-overlay-transitioning')
    }
  }
